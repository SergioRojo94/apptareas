...
function App() {
  ...
  const [userName, setUserName] = useState(ownerName);
  ...
  const toggleTask = task =>
    setTaskItems(taskItems.map(taskChosen => (taskChosen.name === task.name ? { ...taskChosen, done: !taskChosen.done } : taskChosen)))
